...
2. Enter ‘Single-cell’ as the keyword in the search text box on the right side of the page and click on the magnifier icon.
3. On the side menu, scroll down to the Country facet. We will select the United Kingdom.
4. On the side menu, scroll to the facet Target audience. Select ‘Graduate students’.
5. As a result, you get the list of training events about single-cell data analysis available in the United Kingdom for Graduate students.

At any time you may remove any of the filters you applied to reduce stringency of your search.
If you would like to include past events in your search, click on the Show past events button.
...
## Protocol 3: Searching for training materials in TeSS

Training resources (events and materials) may be searched in TeSS in several ways. You can perform a general search based on keywords that will return separate lists of events and materials or you can look for events or materials independently of each other. That second approach will allow you to perform more precise filtering on several parameters, like event type, country and target audience, and even use a combination of these filters. In this protocol, we explain how to search for specific materials.
...
1. Login to TeSS at https://tess.elixir-europe.org following Basic Protocol 3.
...
1.	As outlined in Basic Protocol 3, in order to register for training material in TeSS, login first. 
...
10.	Enter ‘bits@vib.be’ in the Contact field. 
